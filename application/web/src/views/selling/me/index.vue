      ...
      <el-col v-for="(val,index) in sellingList" :key="index" :span="6" :offset="1">
        <el-card class="me-card">
          <div slot="header" class="clearfix">
            ...
            <el-button v-if="val.sellingStatus!=='Finish'&&val.sellingStatus!=='Expired'&&val.sellingStatus!=='Cancelled'" style="float: right; padding: 3px 0" type="text" @click="updateSelling(val,'cancelled')">Cancel</el-button>
            <el-button v-if="val.sellingStatus==='In Delivery'" style="float: right; padding: 3px 8px" type="text" @click="updateSelling(val,'done')">Confirmed Paid</el-button>
          </div>
         <div align="left">
          <div class="item">
